    ...
    <>
        {
            !flag ? (
                <div className='container'>
                    <div className='row'>
                        <div className='col'>
                            <div className='card eounded shadow-lg m-2 chart-true'>
                    ...
                    <div className='stock-column-data'>
                        {
                            summary ? (
                                <>
                        <h2><span style={{color: "black"}}><span className='sumary-span'>{summary.exchangeName} ({summary.symbol})</span> ${summary.regularMarketPrice}</span></h2>
                                <div className='stock-heading'>
                                    ...
                                    <h4><span className='summary-span'>Previous Close:</span><span style={{color: "black"}}>{" "} {summary.chartPreviousClose}</span></h4>
